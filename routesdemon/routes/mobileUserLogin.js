//SELECT * FROM dhulltra_benz.Drivers where PhoneNumber='999040198'&& Password='839766';
...
router.get("/", (req, res) => {
  ...
  mysqlConnection.query(
    "SELECT idDrivers, PhoneNumber, Name, Address, PanNumber, AdhaarNumber, PanPhoto, AadhaarPhoto, AssociatedVehicle FROM dhulltra_benz.Drivers where PhoneNumber='" +
      phoneno +
      "'&& Password='" +
      password +
      "'&& Status=1;",
...
router.get("/:idDrivers", (req, res) => {
  mysqlConnection.query(
    "SELECT * FROM dhulltra_benz.Drivers where idDrivers=?;",
