...
router.get("/", (req, res) => {
    ...
    selectQuery = `SELECT idDealerData,Email as email,'Password' as password,Name as name,'' as avatar  ,'Dealer' as role ,accessToken FROM currency_kharido.DealerData where accessToken='${AccessToken}'`;
...
router.post("/", (req, res) => {
  // console.log(req.headers);
   ...
   // console.log(req.body);
    ...
    CALL sp_login_dealer(@varemail,@varpassword,@accessToken);";
